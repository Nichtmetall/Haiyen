    ...
    >
      ...
      <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden">
        ...
        <motion.div ref={trackRef} style={{ x }} className="flex gap-4 md:gap-10 pl-6 md:pl-24 items-center h-full w-max">
          {galleryPreviewImages.map((img, idx) => (
            <div key={idx} className="relative w-[85vw] md:w-[40vw] shrink-0 aspect-[4/5] md:aspect-[3/4] group overflow-hidden bg-white/5 shadow-md rounded-lg">
              ...
              <div
                ...
                className="absolute inset-0 bg-[#2D4A3E]/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center cursor-pointer"
              >
          ...
          <div className="w-[85vw] md:w-[35vw] shrink-0 aspect-[4/5] md:aspect-[3/4] flex flex-col items-center justify-center bg-[#2D4A3E] text-[#F5F0E8] ml-2 md:ml-10 mr-6 md:mr-24 shadow-xl relative overflow-hidden group rounded-lg">
